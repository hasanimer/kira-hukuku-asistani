...
def main():
    ...
    calc = run('hesap.py', 'tespit', '--baslangic', '01.07.2018', '--artis-sarti', '--json')
    ...
    require(calc10['toplam_yil'] == 11 and calc10['en_gec_ihtar_teblig_tarihi'] == '30.09.2025',
            'hesap.py tahliye-10yil calculation error')
    run('hesap.py', 'tespit', '--baslangic', 'invalid', expected=1)
